function GenerateNormalizedResults(folder,patientid,atlas)
...
if(rows > 0)
    system(['pareg landmarks.vtk ..',seperation,'..',seperation,atlas,seperation,'landmarks.vtk -dofout dofs',seperation,'landmarks.dof.gz -s1']);
    %rigid align to reference vtk
    cmd = ['msareg 3 vtks',seperation,'RV_ED.vtk vtks',seperation,'LVendo_ED.vtk vtks',seperation,'LVepi_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'RV_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'LVendo_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'LVepi_ED.vtk -dofin dofs',seperation,'landmarks.dof.gz -dofout tmps',seperation,'ed.dof.gz -symmetric -s1'];
    system(cmd);
    cmd = ['msareg 2 vtks',seperation,'LVendo_ED.vtk vtks',seperation,'LVepi_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'LVendo_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'LVepi_ED.vtk -dofin tmps',seperation,'ed.dof.gz -dofout tmps',seperation,'lv_ed_rreg.dof.gz -symmetric -s1'];
    system(cmd);
    cmd = ['sareg vtks',seperation,'RV_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'RV_ED.vtk -dofin tmps',seperation,'ed.dof.gz -dofout tmps',seperation,'rv_ed_rreg.dof.gz -symmetric -s1'];
    system(cmd);
    cmd = ['msareg 3 vtks',seperation,'RV_ES.vtk vtks',seperation,'LVendo_ES.vtk vtks',seperation,'LVepi_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'RV_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'LVendo_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'LVepi_ES.vtk -dofin dofs',seperation,'landmarks.dof.gz -dofout tmps',seperation,'es.dof.gz -symmetric -s1'];
    system(cmd);
    cmd = ['msareg 2 vtks',seperation,'LVendo_ES.vtk vtks',seperation,'LVepi_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'LVendo_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'LVepi_ES.vtk -dofin tmps',seperation,'es.dof.gz -dofout tmps',seperation,'lv_es_rreg.dof.gz -symmetric -s1'];
    system(cmd);
    cmd = ['sareg vtks',seperation,'RV_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'RV_ES.vtk -dofin tmps',seperation,'es.dof.gz -dofout tmps',seperation,'rv_es_rreg.dof.gz -symmetric -s1'];
    system(cmd);
else
    %rigid align to reference
    cmd = ['msareg 3 vtks',seperation,'RV_ED.vtk vtks',seperation,'LVendo_ED.vtk vtks',seperation,'LVepi_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'RV_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'LVendo_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'LVepi_ED.vtk -dofout tmps',seperation,'ed.dof.gz -symmetric -s1'];
    system(cmd);
    cmd = ['msareg 2 vtks',seperation,'LVendo_ED.vtk vtks',seperation,'LVepi_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'LVendo_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'LVepi_ED.vtk -dofin tmps',seperation,'ed.dof.gz -dofout tmps',seperation,'lv_ed_rreg.dof.gz -symmetric -s1'];
    system(cmd);
    cmd = ['sareg vtks',seperation,'RV_ED.vtk ..',seperation,'..',seperation,atlas,seperation,'RV_ED.vtk -dofin tmps',seperation,'ed.dof.gz -dofout tmps',seperation,'rv_ed_rreg.dof.gz -symmetric -s1'];
    system(cmd);
    cmd = ['msareg 3 vtks',seperation,'RV_ES.vtk vtks',seperation,'LVendo_ES.vtk vtks',seperation,'LVepi_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'RV_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'LVendo_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'LVepi_ES.vtk -dofout tmps',seperation,'es.dof.gz -symmetric -s1'];
    system(cmd);
    cmd = ['msareg 2 vtks',seperation,'LVendo_ES.vtk vtks',seperation,'LVepi_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'LVendo_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'LVepi_ES.vtk -dofin tmps',seperation,'es.dof.gz -dofout tmps',seperation,'lv_es_rreg.dof.gz -symmetric -s1'];
    system(cmd);
    cmd = ['msareg vtks',seperation,'RV_ES.vtk ..',seperation,'..',seperation,atlas,seperation,'RV_ES.vtk -dofout tmps',seperation,'rv_es_rreg.dof.gz -symmetric -s1'];
    system(cmd);
end
...
%output to txt files
delete('*.txt')
system(['vtk2txt vtks',seperation,'C_RV_ED.vtk scale_normalized_rv_ed_curvature.txt'])
system(['vtk2txt vtks',seperation,'W_RV_ED.vtk scale_normalized_rv_ed_wallthickness.txt'])
system(['vtk2txt vtks',seperation,'S_RV_ED.vtk scale_normalized_rv_ed_signeddistances.txt'])
system(['vtk2txt vtks',seperation,'C_RV_ES.vtk scale_normalized_rv_es_curvature.txt'])
system(['vtk2txt vtks',seperation,'W_RV_ES.vtk scale_normalized_rv_es_wallthickness.txt'])
system(['vtk2txt vtks',seperation,'S_RV_ES.vtk scale_normalized_rv_es_signeddistances.txt'])
system(['vtk2txt vtks',seperation,'W_LVmyo_ED.vtk scale_normalized_lv_myoed_wallthickness.txt'])
system(['vtk2txt vtks',seperation,'C_LVmyo_ED.vtk scale_normalized_lv_myoed_curvature.txt'])
system(['vtk2txt vtks',seperation,'S_LVmyo_ED.vtk scale_normalized_lv_myoed_signeddistances.txt'])
system(['vtk2txt vtks',seperation,'W_LVmyo_ES.vtk scale_normalized_lv_myoes_wallthickness.txt'])
system(['vtk2txt vtks',seperation,'C_LVmyo_ES.vtk scale_normalized_lv_myoes_curvature.txt'])
system(['vtk2txt vtks',seperation,'S_LVmyo_ES.vtk scale_normalized_lv_myoes_signeddistances.txt'])
